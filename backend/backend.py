...
prompt = (
    ...
    "Responda como um oráculo zen, mas sem emojis e sem nenhuma marcação de formatação (como ** ou _). Use apenas texto cru e místico. apenas 3 frases nao crie frases alternativas, ou, outras versoes do mesmo texto, apenas 3 frases. "
)
